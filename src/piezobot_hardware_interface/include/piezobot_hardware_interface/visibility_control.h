...
#ifndef PIEZOBOT_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define PIEZOBOT_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // PIEZOBOT_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
