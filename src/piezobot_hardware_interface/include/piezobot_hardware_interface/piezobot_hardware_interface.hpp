...
private:
  std::vector<double> hw_commands_ = {0, 0, 0, 0, 0, 0};
  std::vector<double> hw_states_ = {0, 0, 0, 0, 0, 0};
  std::unique_ptr<piezobot_commander_rs::PiezobotCommanderRS> piezobot_commander_rs_;
