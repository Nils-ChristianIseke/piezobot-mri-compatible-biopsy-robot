...
#include "miism_controllers/displacement_controller.hpp"
...
using ControllerReferenceMsg = miism_controllers::DisplacementController::ControllerReferenceMsg;
...
DisplacementController::on_configure(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
void DisplacementController::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
  if (msg->joint_names.size() == params_.joints.size()) {
    ...
    RCLCPP_ERROR(
      get_node()->get_logger(), "Received %zu , but expected %zu joints in command. Ignoring message.",
      msg->joint_names.size(), params_.joints.size());
  }
}

controller_interface::InterfaceConfiguration DisplacementController::command_interface_configuration()
const
{
...
controller_interface::CallbackReturn
DisplacementController::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn
DisplacementController::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
PLUGINLIB_EXPORT_CLASS(
  miism_controllers::DisplacementController,
  controller_interface::ControllerInterface)
